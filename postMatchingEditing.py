...
@click.option('--uniprot', '-u', default='data_inputs/uniprotk_9606_2023_09_05.tsv', help='The path to the Uniprot data.')
@click.option('--sec_mw', '-m', default='data_inputs/SEC_MW_input_hekhct.txt', help='The path to the SEC MW input data.')
